...
$sql = "DELETE FROM food_items WHERE created_on < NOW() - INTERVAL 12 HOUR";

if ($conn->query($sql) === TRUE) {
   // echo "Old food items deleted successfully";
} else {
   // echo "Error deleting records: " . $conn->error;
}

// Fetch food items from database
$sql = "SELECT id, created_on, contact_name, contact_phone, time_of_preparation, photo, location, message, quantity, type_of_food, lat, longi FROM food_items order by id desc";
...
<head>
  ...
  <title>Food list - Share Plate </title>
...
<body class="index-page">
  ...
  <div class="container">
        ...
        <h1 class="my-4" align="center">Available Food Items</h1>
                ...
                <?php while($row = $result->fetch_assoc()): ?>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100">                       
                            ...
                            <div class="card-body">
                                <h4 class="card-title"><?php echo htmlspecialchars($row['contact_name']); ?></h4> 
                                <div class="row"> 
                                ...
                                <div class="col-md-8 mb-4">
                                    <p class="card-text">
                                        ...
                                        <a class="btn-getstarted" href="viewfood.php?id=<?php echo htmlspecialchars($row['id']); ?>" >View Details</a>
                                    </p>
                                </div>
                                </div>
                            </div>
